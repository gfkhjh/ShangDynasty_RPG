...
export const createPhaseOneRegionConfig = (): RegionTrialConfig => ({
  definitions: [
    ...
    },
    {
      ...
      cameraBounds: { minX: 600, maxX: 5200, minY: -4100, maxY: -2450 },
    },
  ],
  entries: [
    // -- OUTSKIRTS south ← RIVERBANK --
    {
    ...
    // -- OUTSKIRTS north ↔ ROYAL_TOMB --
    {
      id: 'outskirts-north-road-entry',
      regionId: RegionId.OUTSKIRTS,
      worldPosition: new Vec2(0, 2140),
      facingDirection: 'down',
      safeOffset: 80,
    },
    {
      ...
      worldPosition: new Vec2(2900, -4050),
      facingDirection: 'up',
      safeOffset: 80,
    },
    // -- OUTSKIRTS east ↔ FIELDS --
    {
      id: 'outskirts-east-road-entry',
      regionId: RegionId.OUTSKIRTS,
      worldPosition: new Vec2(1996, 440),
      facingDirection: 'right',
      safeOffset: 80,
    },
    {
      id: 'farmland-west-road-entry',
      regionId: RegionId.FIELDS,
      worldPosition: new Vec2(260, -760),
      facingDirection: 'right',
      safeOffset: 80,
    },
  ],
  exits: [
    // -- South: OUTSKIRTS ↔ RIVERBANK --
    {
    ...
    // -- North: OUTSKIRTS ↔ ROYAL_TOMB --
    {
      ...
      sourceRegionId: RegionId.OUTSKIRTS,
      triggerBounds: { minX: -47, maxX: 47, minY: 2154, maxY: 2170 },
      travelDirection: 'up',
    ...
    },
    {
      ...
      triggerBounds: { minX: 2854, maxX: 2946, minY: -4100, maxY: -4072 },
      travelDirection: 'down',
      targetRegionId: RegionId.OUTSKIRTS,
    ...
    {
      id: 'outskirts-east-road-to-farmland',
      sourceRegionId: RegionId.OUTSKIRTS,
      triggerBounds: { minX: 1972, maxX: 2020, minY: 384, maxY: 496 },
      travelDirection: 'right',
      targetRegionId: RegionId.FIELDS,
      targetEntryId: 'farmland-west-road-entry',
    },
    {
      id: 'farmland-west-road-to-outskirts',
      sourceRegionId: RegionId.FIELDS,
      triggerBounds: { minX: 200, maxX: 248, minY: -816, maxY: -704 },
      travelDirection: 'left',
      targetRegionId: RegionId.OUTSKIRTS,
